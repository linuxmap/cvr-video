...
#define TIMELAPSE_IMG_W 138
#define TIMELAPSE_IMG_H 121

#define MOTIONDETECT_IMG_X (WIN_W / 2 / 2 / 2 / 2 /2 )
#define MOTIONDETECT_IMG_Y (WIN_H / 2 - TIMELAPSE_IMG_H / 2 - WIN_H / 4)
#define MOTIONDETECT_IMG_W 138
#define MOTIONDETECT_IMG_H 121

#define MOTIONDETECT_ON_IMG_X (WIN_W / 2 / 2 / 2 / 2 /2 )
#define MOTIONDETECT_ON_IMG_Y (WIN_H / 2 - TIMELAPSE_IMG_H / 2 - WIN_H / 4)
#define MOTIONDETECT_ON_IMG_W 138
#define MOTIONDETECT_ON_IMG_H 121

#define TIMELAPSE_ON_IMG_X (WIN_W / 2 / 2 / 2 / 2 /2 )
#define TIMELAPSE_ON_IMG_Y (WIN_H / 2 - TIMELAPSE_IMG_H / 2 - WIN_H / 4)
#define TIMELAPSE_ON_IMG_W 138
#define TIMELAPSE_ON_IMG_H 121
